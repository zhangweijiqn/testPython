#coding=utf8
# logistic regression test. reference :http://blog.csdn.net/zouxy09/article/details/20319673
from numpy import *
...
def trainLogRegres(train_x, train_y, opts):
    ...
    for k in range(maxIter):
        if opts['optimizeType'] == 'gradDescent': # gradient descent algorilthm
            output = sigmoid(train_x * weights) #vector
            error = train_y - output            #vector
